...
export default function AboutSection() {
  return (
    <section id="about" className="w-full max-w-5xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
      <div className="bg-card/80 backdrop-blur-sm rounded-xl border border-border flex flex-col shadow-xl overflow-hidden">
